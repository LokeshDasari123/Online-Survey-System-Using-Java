...
public class MainPage {
	...
	public void mainPageView(final int id) throws SQLException {
		this.id=id;
		...
		final JTextField option1Field = new JTextField();
		...
		final JTextField option2Field = new JTextField();
		...
		final JTextField option3Field = new JTextField();
		...
		final JTextField option4Field = new JTextField();
		...
		final JLabel quesView = new JLabel();
		quesView.setBounds(50, 340, 150, 50);
		viewPanel.add(quesView);
		
		final JLabel Opview = new JLabel();
		Opview.setBounds(70,360,150,50);
		viewPanel.add(Opview);
		
		final JLabel Ansview = new JLabel();
		Ansview.setBounds(170,360,150,50);
		viewPanel.add(Ansview);
		
		final JLabel op1View = new JLabel();
		op1View.setBounds(90, 380, 150, 50);
		viewPanel.add(op1View);
		
		final JLabel op2View = new JLabel();
		op2View.setBounds(90, 420, 150, 50);
		viewPanel.add(op2View);
		
		final JLabel op3View = new JLabel();
		op3View.setBounds(90, 460, 150, 50);
		viewPanel.add(op3View);
		
		final JLabel op4View = new JLabel();
		op4View.setBounds(90, 500, 150, 50);
		viewPanel.add(op4View);
		
		final JLabel op1Select = new JLabel();
		op1Select.setBounds(200, 380, 150, 50);
		viewPanel.add(op1Select);
		
		final JLabel op2Select = new JLabel();
		op2Select.setBounds(200, 420, 150, 50);
		viewPanel.add(op2Select);
		
		final JLabel op3Select = new JLabel();
		op3Select.setBounds(200, 460, 150, 50);
		viewPanel.add(op3Select);
		
		final JLabel op4Select = new JLabel();
		op4Select.setBounds(200, 500, 150, 50);
		...
		final JButton viewPrev = new JButton("PREVIOUS");
		...
		viewPrev.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(h>=0) {
					h--;
					Opview.setText("Options");
					Ansview.setText("No.of people selected");
		...
		final JButton viewNext = new JButton("NEXT");
