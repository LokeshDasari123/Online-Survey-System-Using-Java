...
public class Guest {
	...
	public void guestView(final String surveyCode) throws SQLException {
		
		manage = new SQLManage();
		final ResultSet rst = manage.getQuestions(surveyCode);
		opt = new int[50];
		...
		final JLabel ques = new JLabel("Question Here!!!");
		ques.setBounds(80, 200, 500, 30);
		ques.setFont(new Font("Times New Roman", Font.BOLD, 18));
		frame.add(ques);
		
		final JRadioButton op1 = new JRadioButton("Option1");
		final JRadioButton op2 = new JRadioButton("Option2");
		final JRadioButton op3 = new JRadioButton("Opyion3");
		final JRadioButton op4 = new JRadioButton("Option4");
